...
def generate_launch_description():
    ...
    # Task3-2: parallel docking experiment (issue #49).
    # task3_sim.launch.py's field_boundary_publisher/buoy_obstacle_publisher
    # only fabricate costmap obstacles for the simulator's synthetic buoys;
    # on real hardware the dock/buoy costmap comes from the live perception
    # stack (e.g. src/detection/pcl_segmentation) running independently, so
    # it is not part of this bringup.
    ...
    enable_diagnostics_arg = DeclareLaunchArgument(
        ...
        description="Launch generic topic heartbeat diagnostics for Task3")
    ...
    localization = IncludeLaunchDescription(
        ...
        launch_arguments={"enable_diagnostics": "false"}.items())
    ...
    startup_message = LogInfo(
        msg="========== Task3-2 (Parallel Docking) Bringup Started ==========")
    ...
    return LaunchDescription([
        ...
        GroupAction(
            ...
            actions=[startup_message, sensor_layer_timer, nav2_layer_timer,
                     goal_layer_timer, diagnostics_launch],
        ),
    ])
