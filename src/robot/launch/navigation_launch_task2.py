...
def generate_launch_description():
    ...
    auto_cmd_vel_topic = LaunchConfiguration('auto_cmd_vel_topic')
    controller_cmd_vel_topic = LaunchConfiguration('controller_cmd_vel_topic')

    # Task 2 sends MPPI-generated paths straight to ControllerServer's
    ...
    declare_auto_cmd_vel_topic_cmd = DeclareLaunchArgument(
        'auto_cmd_vel_topic',
        default_value='/cmd_vel_nav',
        description='Velocity candidate generated by the Task 2 Nav2 controller')

    declare_controller_cmd_vel_topic_cmd = DeclareLaunchArgument(
        'controller_cmd_vel_topic',
        default_value='/cmd_vel_controller',
        description='Internal Nav2 controller output consumed by velocity_smoother')
    ...
    ld.add_action(declare_auto_cmd_vel_topic_cmd)
