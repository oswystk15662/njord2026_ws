...
THRUSTER GATING
===============
This launch follows the current test07089 convention: thrusters are enabled
by default. Pass ``enable_thrusters:=false`` for dockside validation.
...
def generate_launch_description():
    ...
    tracking_enabled = PythonExpression(
        [
            "'",
            enable_lidar,
            "' == 'true' and '",
    ...
    real_bringup = include_launch(
        ...
        launch_arguments={
            ...
            "enable_thruster": enable_thrusters,
        },
    )
    ...
    task2_perception_launch = include_launch(
        ...
        launch_arguments={
            ...
            "enable_opponent_selector": tracking_enabled,
        },
    )
