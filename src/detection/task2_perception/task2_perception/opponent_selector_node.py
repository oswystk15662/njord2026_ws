...
planner runs with require_other_ship = False and plans without the opponent
after its freshness timeout. This keeps planning available but is not a
...
class OpponentSelectorNode(Node):
    ...
    def timer_callback(self):
        ...
        if not ranked:
            # Silence makes MPPI drop the opponent after its freshness timeout.
