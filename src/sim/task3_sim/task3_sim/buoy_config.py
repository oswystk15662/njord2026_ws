...
BUOY_DEFINITIONS_3_1 = [
    ...
    {'name': 'b31_red_gate',   'center': [12.0, 10.0], 'phase_offset': math.pi},
    ...
    {'name': 'b31_green_gate', 'center': [14.0, 10.0], 'phase_offset': 3.0 * math.pi / 2.0},
]
...
BUOY_DEFINITIONS_3_2 = [
    ...
    {'name': 'b32_red_gate',   'center': [-12.0, -10.0], 'phase_offset': math.pi},
    ...
    {'name': 'b32_green_gate', 'center': [-14.0, -10.0], 'phase_offset': 3.0 * math.pi / 2.0},
]
