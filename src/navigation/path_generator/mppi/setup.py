...
setup(
    ...
    "console_scripts": [
        ...
        "task2_waypoint_marker_publisher = asv_trajectory_planner.task2_waypoint_marker_publisher:main",
        "task2_autonomy_ready_node = asv_trajectory_planner.task2_autonomy_ready_node:main",
        "safety_cloud_gate_node = asv_trajectory_planner.safety_cloud_gate_node:main",
