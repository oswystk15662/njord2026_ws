...
class MyPlanningAlgorithm:
    ...
    def plan(
        ...
        points = self._interpolate_points(key_points)
    ...
    def _build_key_points(
        ...
        # 他船が経路から十分離れている場合は回避しない
        if distance_to_line > self.avoid_radius:
            return [start, goal]

        # 他船が経路の左側にいるか右側にいるかを判定
